...
#+BEGIN_SRC emacs-lisp
  (use-package helm-bibtex
	 ...
	 (setq bibtex-completion-bibliography
			 '(concat (getenv "JOURNAL_DIR") "\\bibliography")))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
	 ...
	 (add-to-list 'load-path "C:\\Users\\Dileban\\.emacs.d\\packages\\org-roam-ui")
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-publish-project-alist
	 `(
		("journal",
		 :base-directory "C:\\Users\\Dileban\\Projects\\github.com\\dileban\\journal\\roam\\"
		 :base-extension "org"
		 :publishing-directory "C:\\Users\\Dileban\\Projects\\github.com\\dileban\\journal\\build\\"
		 :recursive t
